...
/**
 * A central registry that holds all CUJ definitions for the application.
 * TODO(b/431796250): Evaluate a plan to create XML based definitions.
 */
public class CujRegistry {
    ...
    private static final List<CujDefinition> DEFINITIONS = List.of(
