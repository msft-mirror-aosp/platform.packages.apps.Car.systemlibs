...
class HunTagXmlParser {
    ...
    companion object {
        ...
        fun parseHun(context: Context, parser: XmlPullParser): HunState {
            ...
            while (parser.next() != XmlPullParser.END_TAG) {
                ...
                when (parser.name) {
                    ...
                    TRANSITIONS_TAG -> {
                        val transitions =
                            parseTransitions(context, displayId, builder.build(), parser)
        ...
        private fun parseHunVariant(
            ...
            val variantBuilder = HunVariant.Builder(id)
            ...
            val parsers = mapOf<String, VariantPropertyParser>(
                ...
                BOUNDS_TAG to getVariantBoundsParser(displayId),
            ...
            while (parser.next() != XmlPullParser.END_TAG) {
                ...
                parsers[name]?.let {
                    it.parse(context, parser, variantBuilder)
                } ?: run {
